...
contract LensHubStorage {
  bytes32 internal constant CREATE_PROFILE_WITH_SIG_TYPEHASH =
    keccak256("CreateProfileWithSig(string handle,string uri,address followModule,bytes followModuleData,uint256 nonce,uint256 deadline)");
  ...
  bytes32 internal constant SET_FOLLOW_MODULE_WITH_SIG_TYPEHASH =
    keccak256("SetFollowModuleWithSig(uint256 profileId,address followModule,bytes followModuleData,uint256 nonce,uint256 deadline)");
  ...
  bytes32 internal constant FOLLOW_WITH_SIG_TYPEHASH = keccak256("FollowWithSig(uint256[] profileIds,bytes[] datas,uint256 nonce,uint256 deadline)");
  bytes32 internal constant COLLECT_WITH_SIG_TYPEHASH = keccak256("CollectWithSig(uint256 profileId,uint256 pubId,bytes data,uint256 nonce,uint256 deadline)");
